...
- GPT-4 costó ~$100M entrenarlo en 2023. Hoy modelos open source equivalentes cuestan $1M
- Eso significa que **la ventaja competitiva dura meses, no años**
- Cualquier empresa que construya sobre un modelo propietario queda obsoleta cuando sale el siguiente

### 2. La metáfora de vender dólares a $0.99

Esta es la más brillante. Funciona así:

- OpenAI, Anthropic y similares **cobran menos por sus servicios de lo que les cuesta producirlos**
- Lo hacen para crecer rápido y mostrar "revenue growth" a inversores
- Los inversores ven el crecimiento y valúan la empresa en miles de millones
- Pero el negocio subyacente **pierde plata en cada transacción**
- Para que funcione necesitan subir precios... pero si suben precios, los usuarios se van a alternativas más baratas o open source
...
El patrón histórico es claro:
- **Burbuja punto com (2000):** Internet era real y transformó el mundo. Pero el 90% de las empresas que prometían capitalizarlo quebraron. Sobrevivieron Amazon, Google. Murieron miles.
- **La IA probablemente siga el mismo patrón:** la tecnología es real, pero la mayoría de las empresas actuales no van a capturar ese valor.
...
- **Distribución real** con usuarios que no se pueden llevar a otro lado
- **Open source con comunidad** — paradójicamente, dar todo gratis puede ser más sostenible que cobrar por algo que otros copiarán
...
El patrón de muerte era siempre el mismo:
1. Levantar capital con promesas de crecimiento futuro
2. Gastar ese capital en marketing y escala antes de tener product-market fit
3. Necesitar más capital para sobrevivir
4. Los inversores se asustan y cortan el grifo
5. Sin flujo de caja real, la empresa muere en semanas
...
Pero el moat real de Google no es la búsqueda. **Es la red publicitaria.** AdWords/AdSense creó un sistema donde:
- Los anunciantes necesitan a Google para llegar a usuarios
- Los usuarios necesitan a Google para encontrar cosas
- Cada lado del mercado refuerza al otro
...
- Financian think tanks que producen papers académicos favorables a sus posiciones
- Hacen lobby para crear regulaciones que ellas pueden cumplir fácilmente pero que aplastan a competidores más chicos
...
- Genera una casta que se reproduce a sí misma en directorios y consultoras
- Cobra fortunas por credenciales que señalizan conformidad, no capacidad
...
Su lógica es:
- Si tu ventaja depende de que nadie más pueda copiarte, tu ventaja es frágil
- El conocimiento no debería ser propiedad de nadie
- El monopolio que describe Thiel en la práctica se convierte en exactamente el tipo de corporación capturadora que Hotz odia
...
- El software comercial está lleno de vulnerabilidades porque nadie con habilidad real tiene incentivo para buscarlas honestamente
- Las que se encuentran quedan en manos de estados o criminales
...
- El gobierno debería regular a nuestros competidores con los mismos estándares que nosotros establecemos (captura regulatoria)
...
We don't really have people working in those areas, but I'm not saying a marketing event for a profitable company is some great evil, or that there's anything wrong with doing that or the people who organize that. I'm saying that if your company is 80% sales, you have contact us pricing, and you are doing cold calls, that's the problem. 

---

## Qué son las cold calls

Una **cold call** es cuando una empresa te llama o te contacta sin que vos hayas pedido nada. "Frío" porque no hay relación previa — sos un extraño en una lista que compraron o scrapearon.

El modelo enterprise de ventas funciona así:

1. Conseguís una lista de empresas target
2. Un SDR (Sales Development Representative) les manda emails genéricos masivos
...
Todo ese proceso puede durar meses. Y el precio final no tiene nada que ver con el valor real del producto — tiene que ver con cuánto podés pagar vos.

---

## Por qué Hotz odia esto específicamente

La crítica no es al marketing en sí. Es a ese modelo completo como señal de que la empresa no tiene producto real.

Su argumento es simple:

**Si tu producto es bueno, la gente lo busca. No necesitás ir a buscarla vos.**

Cuando ves una empresa con precio oculto, formulario de contacto, y equipo de ventas enorme, lo que estás viendo es una empresa que:

- No confía en que el producto se venda solo
- Necesita información asimétrica para maximizar extracción por cliente
- Tiene más gente vendiendo que construyendo

Para Hotz eso es la señal más clara de que estás ante una empresa que captura valor en vez de crearlo. El producto es secundario — el proceso de ventas es el producto real.

Comma.ai tiene el precio en la web. Lo comprás como cualquier cosa en internet. Sin calls, sin demos, sin negociación.
